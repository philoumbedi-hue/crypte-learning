        ...
        script.onload = () => {
            ...
            const options = {
                ...
                configOverwrite: {
                    ...
                    disableDeepLinking: true,   // Force browser join on mobile
                    disableBeforeUnloadHandlers: true,
                    enableLayerSuspension: true,
                    disableAudioLevels: true,   // Performance boost for mobile
                },
                interfaceConfigOverwrite: {
                    TOOLBAR_BUTTONS: [
                        'microphone', 'camera', 'desktop', 'fullscreen',
                        'fodeviceselection', 'hangup', 'profile', 'info', 'chat',
                        'settings', 'videoquality', 'filmstrip', 'tileview', 'recording'
                    ],
                }
            };
